package com.example.newsappoffline.core.data.mapper

import com.example.newsappoffline.core.data.local.ArticleEntity
import com.example.newsappoffline.core.data.model.ArticleDto
     ...
     fun NewsListDto.toNewsList(): NewsList {
      ...
      fun ArticleDto.toArticle(): Article {
        return Article(
            ...
            image_url = image_url?:"No url found",
            language = language?:"language",
            pubDate = pubDate?:"pubDate",
            source_icon = source_icon?:"source icon missing",
            source_id = source_id?:"",
